...
public class NCConfig {
    ...
    public static Configuration fissionConfig;
    public static Configuration fusionConfig;
    public static Configuration acceleratorConfig;
    ...
    public static void loadConfiguragtion() {
        config = new Configuration(new File("config/NuclearCraft/NCConfig.cfg"));
        fissionConfig = new Configuration(new File("config/NuclearCraft/FissionConfig.cfg"));
        fusionConfig = new Configuration(new File("config/NuclearCraft/FusionConfig.cfg"));
        acceleratorConfig = new Configuration(new File("config/NuclearCraft/AcceleratorConfig.cfg"));
        toolConfig = new Configuration(new File("config/NuclearCraft/ToolConfig.cfg"));
        config.load();
        fissionConfig.load();
        fusionConfig.load();
