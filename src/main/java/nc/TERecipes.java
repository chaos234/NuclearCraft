...
public final class TERecipes {
	...
	public void hook() {
		...
		if(!TELoaded || NCConfig.nonTECoolerRecipes) addTESubstitutes();
	}
	...
	public static void addTERecipes() {
		...
		try {ThermalExpansionHelper.addSmelterRecipe(2000, new ItemStack(NCItems.parts, 1, 0), new ItemStack(NCItems.material, NCConfig.workspace ? 2 : 4, 7), new ItemStack(NCItems.parts, 1, 3));} catch(Exception e) {}
		try {ThermalExpansionHelper.addSmelterRecipe(2400, new ItemStack(NCItems.parts, 1, 0), new ItemStack(NCItems.material, NCConfig.workspace ? 2 : 4, 22), new ItemStack(NCItems.parts, 1, 3));} catch(Exception e) {}
		try {ThermalExpansionHelper.addSmelterRecipe(2000, new ItemStack(NCItems.parts, NCConfig.workspace ? 2 : 3, 3), new ItemStack(NCItems.material, 4, 24), new ItemStack(NCItems.parts, 1, 8));} catch(Exception e) {}
		try {ThermalExpansionHelper.addSmelterRecipe(2000, new ItemStack(NCItems.parts, NCConfig.workspace ? 2 : 3, 3), new ItemStack(NCItems.material, 4, 55), new ItemStack(NCItems.parts, 1, 8));} catch(Exception e) {}
		try {ThermalExpansionHelper.addSmelterRecipe(2400, new ItemStack(NCItems.parts, 2, 8), new ItemStack(NCItems.material, NCConfig.workspace ? 3 : 6, 48), new ItemStack(NCItems.parts, 1, 9));} catch(Exception e) {}
		...
		try {ThermalExpansionHelper.addTransposerFill(1000, new ItemStack(NCItems.fuel, 1, 45), new ItemStack(NCItems.fuel, 1, 75), new FluidStack(NCGameRegistry.liquidHelium, 1000), true);} catch(Exception e) {}
		...
		try {ThermalExpansionHelper.addTransposerFill(1000, new ItemStack(NCBlocks.emptyCoolerBlock, 1), new ItemStack(NCBlocks.heliumCoolerBlock, 1), new FluidStack(NCGameRegistry.liquidHelium, 4000), true);} catch(Exception e) {}
